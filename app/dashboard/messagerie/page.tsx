              ...
              >
                <div className="flex items-start justify-between gap-3">
                  ...
                  {conversation.unread > 0 && (
                    <span className="grid h-7 min-w-7 place-items-center rounded-full bg-blue-600 px-2 text-xs font-black text-white">
                      {conversation.unread}
                    </span>
                  )}
                </div>
                <div className="mt-3 flex items-center justify-between gap-2">
                  <span className={`rounded-full px-3 py-1 text-xs font-black ${statusStyles[conversation.status]}`}>
                    {conversation.status}
                  </span>
        ...
        <section className="flex min-h-0 flex-col overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
          <div className="border-b border-slate-200 p-5">
            <div className="flex items-start justify-between gap-4">
              ...
              <span className={`rounded-full px-4 py-2 text-sm font-black ${statusStyles[selectedConversation.status]}`}>
          ...
          <div className="border-t border-slate-200 bg-white p-4">
            <div className="mb-3 flex gap-2 overflow-x-auto pb-1">
              {quickReplies.map((reply) => (
                <button
                  ...
                  className="shrink-0 rounded-full bg-slate-100 px-4 py-2 text-xs font-black text-slate-600 hover:bg-blue-50 hover:text-blue-700"
                >
            ...
            <div className="flex items-end gap-3 rounded-3xl border border-slate-200 bg-slate-50 p-3">
              ...
              <button
                type="button"
                onClick={sendMessage}
                className="inline-flex h-11 shrink-0 items-center gap-2 rounded-2xl bg-blue-600 px-4 text-sm font-black text-white hover:bg-blue-700"
              >
        ...
        <aside className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h3 className="text-xl font-black">{selectedConversation.name}</h3>
            </div>
          </div>
          ...
          <div className="mt-5 rounded-3xl border border-violet-100 bg-violet-50 p-4">
            <div className="flex items-center gap-2 text-violet-700">
              <Sparkles className="h-5 w-5" />
              <p className="font-black">Seya suggère</p>
            </div>
          ...
          <div className="mt-5 rounded-3xl border border-blue-100 bg-blue-50 p-4">
            <div className="flex items-center gap-2 text-blue-700">
              ...
              <p className="font-black">Notifications mail</p>
            </div>
          ...
          <div className="mt-5 grid gap-3">
            <button className="rounded-2xl border border-slate-200 bg-white px-4 py-3 font-black text-slate-700">
              Ouvrir fiche complète
            </button>
            <button className="rounded-2xl bg-emerald-50 px-4 py-3 font-black text-emerald-700">
