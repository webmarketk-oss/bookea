    ...
    <main className="min-h-screen bg-[#eef3f9] px-6 py-6 text-slate-950">
      <section className="mb-6 flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
        <div>
          ...
          <h1 className="mt-1 text-3xl font-black tracking-tight">Mailing</h1>
      ...
      <section className="grid gap-4 xl:grid-cols-[1fr_0.85fr]">
        <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2 className="text-xl font-black">Créer un mailing</h2>
        ...
        <aside className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
          ...
          <div className="mt-6 rounded-[26px] border border-slate-200 bg-slate-50 p-5">
            ...
            <h3 className="mt-3 text-lg font-black">{subject}</h3>
      ...
      <section className="mt-6 rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
        <h2 className="text-xl font-black">Historique mailing</h2>
